...
//        //设置了填充色或者设置了渐变色的开始和结束，或者设置了描边颜色，才会设置drawable
    ...
    public RecShapeLinearLayout setColorRipple(int colorRipple) {
        this.colorRipple = colorRipple;
        return this;
    }

    public RecShapeLinearLayout setRadiusCorner(int radiusCorner) {
        this.radiusCorner = radiusCorner;
        return this;

    }

    public RecShapeLinearLayout setColorFill(int colorFill) {
        this.colorFill = colorFill;
        return this;
    }

    public RecShapeLinearLayout setStrokeWidth(int strokeWidth) {
        this.strokeWidth = strokeWidth;
        return this;
    }

    public RecShapeLinearLayout setStrokeColor(int strokeColor) {
        this.strokeColor = strokeColor;
        return this;
    }

    public RecShapeLinearLayout setShapeType(int shapeType) {
